          ...
          <div class="row">
              <div class="col-md-3">
                  ...
                  <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="logs.php"><i class="fa fa-pencil-square-o"></i> Our Logs</a></li>
                  </ul>
              </div>
              <div class="col-md-9">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#ourlogs" data-toggle="tab"><i class="fa fa-pencil"></i> Our Logs</a></li>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="ourlogs">Our Logs</div>
