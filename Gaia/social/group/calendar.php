          ...
          <div class="row">
              <div class="col-md-3">
                  ...
                  <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="calendar.php"><i class="fa fa-calendar"></i> Our Calendar</a></li>
              ...
              <div class="col-md-9">
                <ul class="nav nav-tabs">
                  ...
                  <li><a href="#events" data-toggle="tab"><i class="fa fa-list"></i> Events</a></li>
                  <li><a href="#create" data-toggle="tab"><i class="fa fa-pencil"></i> Create Event</a></li>
                </ul>

                <!-- Tab panes -->
                <div class="tab-content">
                  <div class="tab-pane active" id="calendar">Calendar</div>
                  <div class="tab-pane" id="sharing">Sharing</div>
                  <div class="tab-pane" id="events">Events</div>
                  <div class="tab-pane" id="create">Create Event</div>
                </div>
                </div>
          </div>
      </div>  
