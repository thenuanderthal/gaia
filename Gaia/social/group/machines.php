          ...
          <div class="row">
              <div class="col-md-3">
                  ...
                  <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="machines.php"><i class="fa fa-laptop"></i> Our Machines</a></li>
              ...
              <div class="col-md-9">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#machines" data-toggle="tab"><i class="fa fa-laptop"></i> Our Machines</a></li>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="Machines">Our Machines</div>
