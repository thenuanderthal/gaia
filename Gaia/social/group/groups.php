          ...
          <div class="row">
              <div class="col-md-3">
                  ...
                  <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="groups.php"><i class="fa fa-group"></i> Our Groups</a></li>
              ...
              <div class="col-md-9">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#groups" data-toggle="tab"><i class="fa fa-users"></i> Our Groups</a></li>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="groups">Our Groups</div>
