          ...
          <div class="row">
              <div class="col-md-3">
                  ...
                  <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="privacy.php"><i class="fa fa-eye-slash"></i> Our Privacy</a></li>
                      <li><a href="logs.php"><i class="fa fa-pencil-square-o"></i> Our Logs</a></li>
                  </ul>
              </div>
              <div class="col-md-9">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#leech" data-toggle="tab"><i class="fa fa-leaf"></i> Leech Privacy</a></li>
                  <li><a href="#seed" data-toggle="tab"><i class="fa fa-leaf"></i> Seed Privacy</a></li>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="leech">Leech Privacy</div>
                  <div class="tab-pane" id="seed">Seed Privacy</div>
                </div>
                </div>
          </div>
      </div>  
