          ...
          <div class="row">
              <div class="col-md-3">
                  ...
                  <ul class="nav nav-pills nav-stacked">
                      ...
                      <li class="active"><a href="contacts.php"><i class="fa fa-user"></i> My Contacts</a></li>
              ...
              <div class="col-md-9">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#contacts" data-toggle="tab"><i class="fa fa-user"></i> My Contacts</a></li>
                  ...
                  <div class="tab-pane active" id="contacts">
                      ...
                      <form action="" id="list_organizer">
                          ...
                          <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-default btn-xs">Family</button>
                            <button type="button" class="btn btn-default btn-xs">Friends</button>
                            <button type="button" class="btn btn-default btn-xs">Associates</button>
                            <button type="button" class="btn btn-default btn-xs">Others</button>
                          </div>
