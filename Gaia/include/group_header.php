        ...
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <ul class="nav navbar-nav navbar-right">
             <li class="dropdown">
                 <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-group"></i> Group Name<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  ...
                  <li class="divider"></li>
                  <li><a href="credits.php">Logout</a></li>
                </ul>
              </li>
              <li class="dropdown">
             ...
             <li class="dropdown">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-clock-o"></i><b class="caret"></b></a>
                <ul class="dropdown-menu">
                  ...
                  <li><a href="logs.php"><i class="fa fa-pencil-square-o"></i> Our Session Duration</a>
                </ul>
              </li>
              <li class="dropdown">
